...
The sources for Material Mechanics can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/kemeen/material_mechanics
.. _tarball: https://github.com/kemeen/material_mechanics/tarball/master
